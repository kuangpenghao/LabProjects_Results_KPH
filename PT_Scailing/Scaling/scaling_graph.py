...
# 数据：BERT 模型
bert_params = np.array([19905538, 46201602, 58811138, 135623170,369985794])#
...
ax.grid(True, which="both", linestyle='--', alpha=0.6)
plt.tight_layout()
plt.savefig(r'D:\_SHTU_\TKW_Lab\LabProjects_Results_KPH\PT_Scailing\PT_BERT\fig5_loglog_loss_no_fit.png', dpi=300)
plt.show()
...
ax.grid(True, which="both", linestyle='--', alpha=0.6)
plt.tight_layout()
plt.savefig(r'D:\_SHTU_\TKW_Lab\LabProjects_Results_KPH\PT_Scailing\PT_BERT\fig6_loglog_ppl_no_fit.png', dpi=300)
plt.show()